...
public class CadastroComSucesso {
	...
	public void deveInterargirComAlertSimples() {	
		driver.findElement(By.id("elementosForm:nome")).sendKeys("Laércio");
		...
		Assert.assertTrue(driver.findElement(By.id("descNome")).getText().endsWith("Laércio"));
	...
	@Test
	public void deveValidarComidaVegetarianaObrigatorio() {
		driver.findElement(By.id("elementosForm:nome")).sendKeys("Laércio");
		driver.findElement(By.id("elementosForm:sobrenome")).sendKeys("Gonçalves");
		driver.findElement(By.id("elementosForm:sexo:0")).click();
